...
<div class="container mt-3">
    ...
    text-align:center;">Our Expertise</span><br>
            ...
            <div style="line-height:35px;color:black;font-weight:bold;font-size:large;">
                ...
                <li> DRT <span>Cases </span> (Debt  Recovery <span class="deed"> Tribunal) </span> </li>
                ...
                <div style="display:flex;" >
                    <div >
                        <li> Simple <span >mortgage Deed</span> <span class="deed"> Registration &  Cancellation</span> </li>
                        ...
                        <li> Trust Deed & Agency <span class="deed" > Agreement,etc…</span></li> </div>  </div>
                        <br>
                        <div>
                        ...
                        <li>Adangal</li>
                        <li>DTCP Approval<br> <span class="ml-4">(Director of town & country <span class="deed"> Planning  Approval)</span></li>
