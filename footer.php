    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-xl-3 col-lg-6">
                <div class="footer-widget footer-widget__quick-link">
                    <h3 class="footer-widget__title">Practices</h3><!-- /.footer-widget__title -->
                    <ul class="footer-widget__links list-unstyled">
                        <li><a href="mos.php">Modes of Service</a></li>
                        <li><a href="nps.php">Notary Public Service</a></li>
                        <li><a href="practice.php">Practice Focusing</a></li>
                        <li><a href="empannelments.php">Empannelments</a></li>
...
<div class="side-menu__block">
    ...
    <div class="side-menu__block-inner ">
        <a href="index-2.php"><img src="assets/images/resources/logo-dark-1-1.png" alt="Awesome Image" /></a>
        ...
        <p class="side-menu__block__text site-footer__copy-text"><a href="#">cgk</a> <i class="far fa-copyright"></i> 2019 All Right Reserved</p>
